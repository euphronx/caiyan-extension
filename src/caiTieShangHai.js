async function caiTieShangHai(date) {
  const result = await fetch(
    `https://xiaoce.fun/api/v0/quiz/daily/metro/get?date=${date}&city=%E4%B8%8A%E6%B5%B7`,
    {
      headers: {
        "accept": "*/*",
        ...
        "sec-gpc": "1",
        "Referer": "https://xiaoce.fun/metro/shanghai",
      },
    }
  );
